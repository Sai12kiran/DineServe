...
public class MainMaps extends AppCompatActivity  implements ActivityCompat.OnRequestPermissionsResultCallback {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(mLayout, "Location access is required to display restaurants near you.",
                ...
                public void onClick(View view) {
                    ...
                    ActivityCompat.requestPermissions(MainMaps.this,
